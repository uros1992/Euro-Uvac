export const translations = {
  sr: {
    nav: { tours: "Tura", experience: "Otkrijte Uvac", reviews: "Recenzije", location: "Kako do nas", book: "Rezerviši", profileTitle: "Moje rezervacije / Admin", myBookings: "Moje rezervacije" },
    hero: {
    ...
    usp: {
      title: "Šta ćete otkriti na krstarenju Uvcem",
      subtitle: "Tokom naše ture otkrićete tri najveća bisera Uvca – svaki sa svojom jedinstvenom pričom.",
      f1Title: "Beloglavi sup",
    ...
    footer: {
      desc: "Uvac Griffon je brend porodičnog preduzeća Euro Uvac iz Nove Varoši, osnovanog 2021. godine. Posvećeni smo organizovanju krstarenja i promociji održivog turizma u Specijalnom rezervatu prirode Uvac",
    ...
    notFound: {
      ...
      message: "Žao nam je, stranica koju tražite ne postoji ili je premeštena.",
      backHome: "Nazad na početnu"
    }
  },
  en: {
    nav: { tours: "Tour", experience: "Discover Uvac", reviews: "Reviews", location: "How to Reach Us", book: "Book Now", profileTitle: "My Bookings / Admin", myBookings: "My Bookings" },
    hero: {
    ...
    usp: {
      title: "Wonders Awaiting You on the Uvac Cruise",
      subtitle: "On our tour you will discover the three greatest gems of Uvac – each with its own unique story.",
      f1Title: "Griffon Vulture",
    ...
    tours: {
      ...
      t1Price: "2000 RSD",
      t1Unit: "/pp*",
      priceDisclaimer: "* Nature Reserve and Ice Cave entry fees are charged separately (420 RSD) on-site.",
    ...
    location: {
      ...
      subtitle: "Getting to the heart of the Uvac Nature Reserve is easier than you think. Your journey will take you through some of the most beautiful landscapes in Serbia—leading to a destination that truly delivers.",
    ...
    footer: {
      desc: "Uvac Griffon is a brand of the family company Euro Uvac from Nova Varoš, founded in 2021. We are dedicated to organizing cruises and promoting sustainable tourism in the Uvac Special Nature Reserve",
      copyright: "Uvac Griffon © 2026",
